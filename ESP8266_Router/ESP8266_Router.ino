...
#define TimeToWaitForRouterReset 3*60*1000 //in milliseconds
static const char GSSID[] PROGMEM = "bamboo"; //"YourSSID";
static const char GPASS[] PROGMEM = "Slomekudask61$"; //"YourPASSWORD";
const String TargetHTTP = "http://www.google.com";
...
IPAddress static_ip(192, 168, 20, 222); //Requested static IP address for the ESP
IPAddress static_gateway(192, 168, 20, 1); // IP address for the Wifi router
